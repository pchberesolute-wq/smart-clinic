// js/pages/about.js
// 🚀 Enterprise Module: About System, Versioning & Unified Tech Stack (v6.0.0-PRO)
...
class AboutPageComponent {
    ...
    get html() {
        return `
            <style>
                ...
                .about-custom-box { background-color: var(--bg-surface, #f8fafc); border: 1px solid var(--border-color, #e2e8f0); transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); }
                .about-copyright-box { background-color: var(--bg-body, #ffffff); border: 1px solid var(--border-color, #e2e8f0); transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); }
                .team-card-hover { transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); cursor: default; }
                ...
                .changelog-box { background: var(--bg-surface, #f8fafc); border-radius: 16px; border: 1px solid var(--border-color, #e2e8f0); padding: 24px; margin-top: 30px; transition: background 0.3s, border 0.3s; }
                ...
                /* Avatar Native Border fix */
                .team-avatar-icon { border: 2px solid var(--bg-surface) !important; }
            </style>
                    ...
                    <div class="modern-panel p-5 h-100 position-relative overflow-hidden shadow-sm" style="border-top: 5px solid var(--primary); background-color: var(--bg-surface);">
                        ...
                        <div class="d-flex align-items-center mb-4 position-relative z-1">
                            <div class="app-logo-frame me-4">
                                <img src="./img/logo.png" alt="${this.systemName} Logo" decoding="async" fetchpriority="high" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=200&auto=format&fit=crop';" style="width:80px; border-radius:16px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                            </div>
                            <div>
                        ...
                        <div class="changelog-box position-relative z-1 shadow-sm">
                            <div class="changelog-header d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-success-subtle text-success-emphasis border border-success-subtle rounded-pill shadow-sm">Latest Update</span>
                            </div>
                            
                            <div class="changelog-item">
                                <div class="changelog-icon bg-danger-subtle text-danger border border-danger border-opacity-25 shadow-sm"><i class="fa-solid fa-shield-halved"></i></div>
                            ...
                            <div class="changelog-item">
                                <div class="changelog-icon bg-info-subtle text-info border border-info border-opacity-25 shadow-sm"><i class="fa-solid fa-microchip"></i></div>
                                <div class="changelog-text">
                            ...
                            <div class="changelog-item">
                                <div class="changelog-icon bg-primary-subtle text-primary border border-primary border-opacity-25 shadow-sm"><i class="fa-solid fa-terminal"></i></div>
                                <div class="changelog-text">
                            ...
                            <div class="changelog-item">
                                <div class="changelog-icon bg-warning-subtle text-warning-dark border border-warning border-opacity-25 shadow-sm"><i class="fa-solid fa-database"></i></div>
                                <div class="changelog-text">
                            ...
                            <div class="changelog-item">
                                <div class="changelog-icon bg-success-subtle text-success border border-success border-opacity-25 shadow-sm"><i class="fa-solid fa-print"></i></div>
                                <div class="changelog-text">
                ...
                <div class="col-xl-4 col-lg-5 fade-in-up" style="animation-delay: 0.2s;">
                    <div class="modern-panel p-4 h-100 d-flex flex-column" style="border-top: 5px solid var(--danger); background-color: var(--bg-surface);">
                        <div class="text-center mb-4 pb-4 border-bottom" style="border-color: var(--border-color) !important;">
                            <div class="rounded-circle bg-danger-subtle text-danger d-inline-flex align-items-center justify-content-center shadow-sm mb-3 border border-danger border-opacity-25" style="width: 65px; height: 65px;">
                            ...
                            <div class="p-4 mt-3 about-copyright-box rounded-4 text-start shadow-sm transition-all">
                                ...
                                <div class="text-muted fw-bold" style="font-size: 12px; line-height: 1.8;">
                                    <div class="d-flex mb-1"><i class="fa-solid fa-building-circle-check text-success mt-1 me-2" style="width: 14px;"></i> <span><b>Enterprise License:</b><br><span class="text-dark">${this.escapeHTML(this.licensee)}</span></span></div>
                        ...
                        <div class="mt-auto pt-3 border-top" style="border-color: var(--border-color) !important;">
                            <div class="d-flex align-items-center justify-content-between p-3 about-custom-box rounded-4">
                                ...
                                <span class="badge bg-success shadow-sm rounded-pill py-2 px-3"><i class="fa-solid fa-satellite-dish me-1"></i> Firebase Active</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    _generateTechStackCards() {
        ...
        return stacks.map(stack => `
            <div class="col-md-6 col-lg-4">
                <div class="p-3 about-custom-box rounded-4 h-100 team-card-hover d-flex flex-column transition-all shadow-sm">
    ...
    _generateTeamCards() {
        const teams = [
            ...
            { name: "ฝ่ายสารสนเทศ (IT Support)", role: "System Infrastructure & Deployment Operation", color: "warning-dark" } // Changed from warning to warning-dark for contrast
        ];
        
        return teams.map(t => `
            <div class="d-flex align-items-center p-3 mb-2 rounded-4 about-custom-box team-card-hover cursor-default shadow-sm">
                <!-- 🚨 THE FIX: เปลี่ยน border-white เป็น team-avatar-icon ให้รับรู้สีพื้นผิวปัจจุบัน (CSS Variables) -->
                <div class="rounded-circle bg-${t.color}-subtle text-${t.color} d-flex align-items-center justify-content-center me-3 shadow-sm team-avatar-icon transition-all flex-shrink-0" style="width: 45px; height: 45px;">
